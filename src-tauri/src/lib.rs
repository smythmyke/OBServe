...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            pad_capture::save_pad_state_to_disk,
            pad_capture::load_pad_state_from_disk,
            pad_capture::save_pad_preset,
            pad_capture::load_pad_preset,
            pad_capture::list_pad_presets,
            pad_capture::delete_pad_preset,
            pad_capture::rename_pad_preset,
            pad_capture::export_pad_preset_zip,
            pad_capture::import_pad_preset_zip,
            pad_capture::list_samples_directory,
